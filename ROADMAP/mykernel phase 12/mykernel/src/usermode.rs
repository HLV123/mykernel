...
pub fn init_syscalls() {
    unsafe {
        ...
        // STAR MSR:
        // [47:32] = 0x08 (kernel CS) → syscall: CS=0x08, SS=0x10
        // [63:48] = 0x10 → sysretq: CS=0x10+16=0x20|3=0x23, SS=0x10+8=0x18|3=0x1b
    ...
    serial_println!("[syscall] EFER.SCE=1 LSTAR={:#x} STAR=0x0010_0008_0000_0000",
...
pub unsafe extern "C" fn syscall_handler() {
    core::arch::naked_asm!(
        ...
        "push r14",
        "push r15",
        // Shift args: syscall_nr=rax→rdi, arg1=rdi→rsi, arg2=rsi→rdx, arg3=rdx→rcx
        "mov rcx, rdx",
        "mov rdx, rsi",
        "mov rsi, rdi",
        "mov rdi, rax",
...
pub fn enter_user_mode(entry: u64) -> ! {
    enter_user_mode_with_stack(entry, 0x800000u64)
}
