...
/// ELF64 Loader
///
/// Parse ELF64 binary, load PT_LOAD segments vÃ o process address space,
/// setup initial stack vá»›i argc/argv, jump vÃ o entry point trong ring 3.
///
/// ELF format tÃ³m táº¯t:
...
/// Load ELF binary vÃ o address space
///
/// # Arguments
...
/// Load má»™t segment vÃ o address space
fn load_segment(
    data: &[u8],
    vaddr: u64,
    filesz: usize,
...
/// Táº¡o minimal ELF64 binary trong memory Ä‘á»ƒ test loader
/// Binary nÃ y chá»‰ cháº¡y syscall write + exit
